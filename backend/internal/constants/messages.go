...
const (
	...
	MsgTranscriptCreated  = "转写草稿创建成功"
	MsgTranscriptSaved    = "转写分段保存成功"
	MsgTranscriptSubmitted = "转写稿已提交审核"
	MsgSegmentConfirmed   = "分段已确认"
	MsgTranscriptApproved = "转写稿审核通过"
	MsgTranscriptRejected = "转写稿已退回"
